function scene = fbt_scene_2
% original development scene from Jan: ball from center, 2 observers at the side
...
scene.ball.x        =   0.0; % ball from center spot straight towards goalie, no z, 10m/s
scene.ball.y        =   0.0;
scene.ball.z        =   0.0;
scene.ball.vx       =   0.0; 
scene.ball.vy       =  -5.0;
