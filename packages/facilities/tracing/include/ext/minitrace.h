...
// Hot flushes all traces to disk
void mtr_flush_to_disk(void);

// Returns the position indicator in the open file stream
long mtr_file_pos(void);
...
#define MTR_INSTANT_S(c, n, aname, astrval) internal_mtr_raw_event_arg(c, n, 'I', 0, MTR_ARG_TYPE_STRING_COPY, aname, (void *)(astrval))
...
#define MTR_SCOPE_C(c, n, aname, astrval) printf("MTR_ENABLED not defined in .h");
