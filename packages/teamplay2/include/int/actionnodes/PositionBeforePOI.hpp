...
#ifndef POSITIONBEFOREPOI_HPP
#define POSITIONBEFOREPOI_HPP

#include "behaviortree_cpp_v3/action_node.h"

#include "int/actionnodes/AbstractAction.hpp"

class PositionBeforePOI : public BT::StatefulActionNode, public AbstractAction
{
  public:
    PositionBeforePOI(const std::string& name, const BT::NodeConfiguration& config)
