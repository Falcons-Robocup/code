...
public:
    fileReader(QWidget *window = nullptr, QGraphicsView *camView = nullptr, QGraphicsScene *camScene = nullptr, QSlider *slider = nullptr, detector *det = nullptr, mjpgSender *mjpgSend = nullptr);
    void config();
