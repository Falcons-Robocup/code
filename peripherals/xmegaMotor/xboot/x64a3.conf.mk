...
# ENTER_DELAY
# 3x3000 does not work with avrdude, 4x3000 works, to be sure use 5x3000
# this is about 500ms before the board is available for motor control
ENTER_BLINK_COUNT     = 5
ENTER_BLINK_WAIT      = 3000
