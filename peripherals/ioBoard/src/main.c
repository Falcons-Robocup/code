...
static void command_set_keeper_frame_right();
static void command_set_keeper_frame_up();
static void command_set_keeper_frame_left();
...
void setup()
{
    ...
    // Initialize the keeper pulse
    Keeper_Frame_Pulse_initialize();
    ...
    while (true)  //super loop
    {
        if (Package_receive(&package))
        {
            ...
            case CMD_SET_BOOTLOADER:
                ...
                break;
            case CMD_SET_KEEPER_FRAME_RIGHT:
                command_set_keeper_frame_right();
                break;
            case CMD_SET_KEEPER_FRAME_UP:
                command_set_keeper_frame_up();
                break;
            case CMD_SET_KEEPER_FRAME_LEFT:
                command_set_keeper_frame_left();
                break;
            default:
...
void command_set_keeper_frame_right()
{
    Keeper_Frame_Pulse_trigger_right();
}

void command_set_keeper_frame_up()
{
    Keeper_Frame_Pulse_trigger_up();
}

void command_set_keeper_frame_left()
{
    Keeper_Frame_Pulse_trigger_left();
}
